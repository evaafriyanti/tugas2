...
<html lang="en">
  <head>
    ...
    <title>Eva Afriyanti Shop | Home</title>
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>0895-7018-6860-4</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li class="hidden-xs"><a href="{{url('/login')}}">Login</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.html">
                  ...
                  <p>Eva Afriyanti<strong>Shop</strong> <span>tempatnya anda berbelanja</span></p>
                </a>
                <!-- img based logo -->
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
             ...
             <li><a href="#">Digital <span class="caret"></span></a>
              ...
              <li><a href="{{url('/blog-archive')}}">Blog <span class="caret"></span></a>
                <ul class="dropdown-menu">                
                  <li><a href="{{url('/blog-archive')}}">Blog Style 1</a></li>
                  <li><a href="{{url('/blog-archive-2')}}">Blog Style 2</a></li>
              ...
              <li><a href="#">Pages <span class="caret"></span></a>
                <ul class="dropdown-menu">                
                  <li><a href="{{url('/product')}}">Shop Page</a></li>
                  <li><a href="{{url('/product-detail')}}">Shop Single</a></li>                
      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="img/slide-02.jpg" alt="Men slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="img/banner-013.jpg" alt="Wristwatch slide img" />
              </div>
              <div class="seq-title">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="img/banner-012.jpg" alt="Women Jeans slide img" />
              </div>
              <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="img/banner-011.jpg" alt="Shoes slide img" />
              </div>
              <div class="seq-title">
                <span data-seq>Save Up to 75% Off</span>                
            ...
            <!-- single slide item -->  
             <li>
              <div class="seq-model">
                <img data-seq src="img/banner-016.jpg" alt="Male Female slide img" />
              </div>
              <div class="seq-title">
            ...
            <div class="row">
              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="img/banner-01.jpg" alt="img">                    
                    <div class="aa-prom-content">
                      <span>75% Off</span>
                      <h4><a href="{{url('women')}}">For Women</a></h4>                      
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="img/gallery-01.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>25% Off</span>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban8.png" alt="polo shirt img"></a>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban10.jpg" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban4.jpg" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban5.jpg" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban11.jpg" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban6.png" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban7.jpg" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/ban12.jpg" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="http://www.markups.io/">Eva Afriyanti</a></p>
